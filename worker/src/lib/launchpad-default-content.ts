// Default content for the gonex-launchpad template.
// Copied from gonex-launchpad/src/lib/default-content.ts
// Seeded into DB when a new gonex-launchpad site is created.

export const launchpadDefaultContent = {
  global: {
    siteName: "GoNex",
